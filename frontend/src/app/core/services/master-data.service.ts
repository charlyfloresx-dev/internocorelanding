...
export class MasterDataService {
  ...
  /**
   * Crea un nuevo producto con su versión inicial.
   * @param payload Datos para la creación del producto.
   */
  createProduct(payload: ProductCreatePayload): Observable<ApiResponse<ProductRead>> {
    return this.http.post<ApiResponse<ProductRead>>(`${this.apiUrl}/products/`, payload);
  }

  // Future methods for Products, Brands, and Categories will be added here.
}