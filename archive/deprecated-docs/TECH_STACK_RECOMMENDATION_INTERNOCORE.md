...
**Propósito:** Este documento es la 'Constitución Técnica' que define el stack tecnológico, los principios y los patrones de diseño para todos los microservicios desarrollados dentro de `internocore_base`. Su objetivo es garantizar la creación de un sistema robusto, escalable y mantenible que funcione de manera idéntica en dos modelos de despliegue radicalmente diferentes: **SaaS Multi-tenant (Cloud)** y **Single-tenant (On-Premise)**.
