...
export class ApiSimulationService {
  ...
  private documents: InventoryDocument[] = [
    ...
    { id: 'doc-mirror', folio: 'ICT-IN-2026-02-005', sequence_number: 5, deliveryDate: new Date().toISOString(), conceptId: 'ict-in', conceptName: 'Traspaso Inter-Company (Espejo)', conceptType: ConceptType.Entry, warehouseId: '1', warehouseName: 'Almacén Central', reference: 'EXP-992', description: 'Documento entrante desde Empresa A', total_amount: 5000.00, status: DocumentStatus.Draft, movements: [] }
  ];
