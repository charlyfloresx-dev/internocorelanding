"""add_audit_logs to subscription_db

Revision ID: 001_add_audit_logs_sub
Revises: 000_subscription_baseline
...
revision: str = '001_add_audit_logs_sub'
down_revision: Union[str, None] = '000_subscription_baseline'
