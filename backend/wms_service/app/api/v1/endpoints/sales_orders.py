...
from app.schemas.sales_order import SalesOrderCreate, SalesOrderRead
from app.application.commands import CreateSalesOrderCommand
from app.application.handlers import CreateSalesOrderHandler
