...
async def get_fifo_preview(
    ...
    from app.models.customs_pedimento import CustomsPedimento
    from sqlalchemy import select
...
# Import at the end to avoid circular imports if any, although here it's just for type hinting
from app.schemas.inventory import StockRelocationCreate
