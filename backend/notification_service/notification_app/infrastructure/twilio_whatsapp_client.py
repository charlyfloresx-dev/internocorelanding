...
class TwilioWhatsAppClient(BaseWhatsAppClient):
    """
    Twilio-specific WhatsApp client adapter implementing BaseWhatsAppClient.
    """
    ...
    async def send_group_message(
        ...
        # Note: we use self._client to perform the call
