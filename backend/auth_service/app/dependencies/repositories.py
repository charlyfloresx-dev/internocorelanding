...
from app.infrastructure.repositories.sqlalchemy_user_company_role_repository import SQLAlchemyUserCompanyRoleRepository
from app.infrastructure.repositories.sqlalchemy_permission_repository import SQLAlchemyPermissionRepository
